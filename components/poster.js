...
function Poster({ track, chooseTrack }) {
    ...
    return (
        ...
        */
        <div className=" h-[22.5rem] w-[16.25rem] rounded-[3rem] overflow-hidden 
            ...
            <img 
                src={track.albumUrl}
                alt="album-image"
                className=" h-full width-full object-cover rounded-[50px] opacity-80
                            group-hover:opacity-100 absolute inset-0" 
            />

            <div className="absolute bottom-10 inset-x-0 ml-4 flex items-center space-x-3.5">

                <div className=" h-10 w-10 bg-[#15883e] flex items-center justify-center
